...
pub struct NoCodeApp {
    ...
    pub(crate) props_params: String,
    pub(crate) props_args: String,
    pub(crate) props_fields: String,
    pub(crate) props_variants: String,
    pub(crate) props_items: String,
    pub(crate) props_into: String,
...
impl NoCodeApp {
    pub fn new(cc: &eframe::CreationContext<'_>) -> Self {
        ...
        let mut app = Self {
            ...
            props_params: String::new(),
            props_args: String::new(),
            props_fields: String::new(),
            props_variants: String::new(),
            props_items: String::new(),
            props_into: String::new(),
